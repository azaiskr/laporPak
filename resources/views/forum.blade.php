            ...
            <div>
                ...
                <div class="flex flex-col mb-4">
                    ...
                    <div class="flex items-center justify-center mt-4">
                        <button type="button"
                            class="text-black border border-black bg-white- hover:bg-blue-300 focus:ring-4 focus:outline-none focus:ring-blue-300 focus:bg-blue-600 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center">
                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 14 10" style="transform: rotate(-90deg); transform-origin: center;">
                        ...
                        <button type="button"
                            class="text-black border border-black bg-white- hover:bg-red-300 focus:ring-4 focus:outline-none focus:ring-red-300 focus:bg-red-600 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center">
                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 14 10" transform="rotate(90)">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
                            </svg>
                ...
                <div class="flex flex-col mb-4">
                    ...
                    <div class="flex items-center justify-center mt-4">
                        ...
                        <button type="button"
                            class="text-black border border-black bg-white- hover:bg-red-300 focus:ring-4 focus:outline-none focus:ring-red-300 focus:bg-red-600 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center">
                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 14 10" transform="rotate(90)">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
                            </svg>
                            <span class="sr-only">Downvote</span>
