...
<body class="flex flex-col min-h-screen font-sans antialiased dark:bg-[#f4f4f4] dark:text-black/50">
    ...
    <main class="w-full my-4 flex-grow">
        ...
        <section class="my-4 lg:max-w-[567px] mx-auto relative">
            <input type="text" class="pl-10 px-4 py-2 bg-white rounded-full w-full text-black border-none drop-shadow-md" placeholder="Cari Laporan">
            <svg class="absolute left-3 top-1/2 transform -translate-y-1/2 h-6 w-6 text-black" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <section class="lg:max-w-[550px] mx-auto p-3 bg-white rounded-2xl drop-shadow-md mb-4 font-bold text-black">
            ...
            <div class="flex justify-center items-center text-xs">
                <button class="bg-gray-300 flex items-center px-7 py-1 m-2 rounded-full border borde-none">Weekly</button>
                <button class="bg-[#f4f4f4] px-7 py-1 m-2 rounded-full border border-black">Monthly</button>
            </div>
            </div>
        </section>
            ...
            <div>
                ...
                <div class="flex">
                    ...
                    {{-- <div class="flex justify-center items-center ml-8">
                        <div class="flex gap-3 items-center">
                            <div>
                                <span class="text-xs font-extrabold">Laporan Palsu</span>
                            </div>
                            <div class="bg-red-500 aspect-square w-6 rounded-full"></div>
                        </div>
                    </div> --}}
                </div>
                ...
                <div class="items-center mt-4">
                    <p class="px-3 m-2 rounded-md">Laporan Singkat: Kerusakan Jalan di [Nama Lokasi]</p>
                    <p class="px-3 m-2 rounded-md">Tanggal: [Tanggal Laporan]</p>
                    <p class="px-3 m-2 rounded-md">Lokasi: [Alamat atau Nama Jalan]</p>
                </div>
                ...
                <div class="flex flex-col mb-4">
                    ...
                    <div class="flex items-center justify-center mt-4">
                        <button type="button" class="text-black border border-black bg-white- hover:bg-blue-300 focus:ring-4 focus:outline-none focus:ring-blue-300 focus:bg-blue-600 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center">
                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10" style="transform: rotate(-90deg); transform-origin: center;">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                            </svg>
                            <span class="sr-only">Upvote</span>
                        </button>
                        <span class="px-3 m-2 rounded-md text-xl font-extrabold">24</span>
                        <button type="button" class="text-black border border-black bg-white- hover:bg-red-300 focus:ring-4 focus:outline-none focus:ring-red-300 focus:bg-red-600 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center">
                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10" transform="rotate(90)">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                            </svg>
            ...
            <div>
                ...
                <div class="flex">
                    ...
                    <div class="flex justify-center items-center ml-8">
                        <div class="flex gap-3 items-center">
                            <div>
                                <span class="text-xs font-extrabold">Laporan Terverifikasi</span>
                            </div>
                ...
                <div class="flex flex-col mb-4">
                    ...
                    <div class="flex items-center justify-center mt-4">
                        ...
                        <span class="px-3 m-2 rounded-md text-xl font-extrabold">123</span>
                        <button type="button" class="text-black border border-black bg-white- hover:bg-red-300 focus:ring-4 focus:outline-none focus:ring-red-300 focus:bg-red-600 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center">
                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10" transform="rotate(90)">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                            </svg>
