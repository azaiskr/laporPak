            ...
            <div>
                ...
                <div class="flex justify-center items-center text-xs">
                    <a href="{{ url('/forum/weekly') }}"
                        class="bg-gray-300 flex items-center px-7 py-1 m-2 rounded-full border-none">Weekly</a>
                    <a href="{{ url('/forum/monthly') }}"
                        class="bg-[#f4f4f4] px-7 py-1 m-2 rounded-full border border-black">Monthly</a>
                </div>
                ...
                <div>
                    ...
                    <div class="flex">
                        ...
                        <div class="flex justify-center items-center ml-8">
                            <div class="flex gap-3 items-center">
                                <div>
                                    <span class="text-xs font-extrabold">Laporan {{ $newestReport->status->status }}</span>
                                </div>
