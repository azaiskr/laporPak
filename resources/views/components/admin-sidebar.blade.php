...
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-600">
        <div>
        <div class="flex px-4 items-center justify-between sm:justify-center py-4">
            <!-- Logo Section -->
        ...
        <div class="flex flex-col gap-2 mt-4 items-start mb-4 px-4 z-40">
            <div class="flex items-center gap-3">
                <div class="bg-gray-300 aspect-square w-10 rounded-full"></div>
                <div>
                    @auth
                    ...
                    @endauth
                    <br />
                    <span class="text-xs text-white">Admin@example.com</span>
                </div>
            </div>
        </div>
    </div>
    <hr/>
      <ul class="space-y-2 font-medium">
         <li>
            <a href="{{ route('admin-dashboard') }}" class="flex items-center p-2 text-gray-200 rounded-lg">
                ...
                <span class="{{ Route::currentRouteName() == 'admin-dashboard' ? 'text-gray-200' : '' }} ms-3">
                    Dashboard
                </span>
            </a>
         </li>
        <li>
            <a href="{{ route('admin-report') }}" class="flex items-center p-2 text-gray-200 rounded-lg">
                ...
                <span class="{{ Route::currentRouteName() == 'admin-report' ? 'text-gray-200 w-full' : '' }} ms-3">
                    Laporan
                </span>
            </a>
         </li>
